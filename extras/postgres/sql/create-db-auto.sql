...
-- (9) psql --dbname=postgres --username=postgres --file=/sql/create-db-auto.sql
-- (10) exit
...
CREATE TABLESPACE kundespace OWNER auto LOCATION '/var/lib/postgresql/tablespace/auto';
