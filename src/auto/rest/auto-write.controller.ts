...
export class AutoWriteController {
     ...
     * gesetzt und genauso auch wenn der Modell oder die MODELLNUMMER-Nummer bereits
     * existieren.
     *
     ...
     * Modell oder die neue MODELLNUMMER-Nummer bereits existieren.
     *
    ...
    #handleModellExists(
        ...
        const msg = `Der Modell "${modell}" existiert bereits.`;
    ...
    #handleModellnummerExists(
        ...
        const msg = `Die MODELLNUMMER-Nummer "${modellnummer}" existiert bereits.`;
